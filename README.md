    ...
    def play(self):
        while True:
            ...
            if self.player_turn == 'X':
                ...
                print('AI chooses: X = {}, Y = {}'.format(px, py))
...
if name == "main": main()
## OUTPUT:
<img width="647" height="730" alt="image" src="https://github.com/user-attachments/assets/b9122924-fb4c-4f91-b8b7-125d597be79f" />
<img width="662" height="732" alt="image" src="https://github.com/user-attachments/assets/c351425b-f049-4969-ae4b-0edf7412a459" />
<img width="652" height="695" alt="image" src="https://github.com/user-attachments/assets/6d6d6a90-85bf-4eab-b2c3-4c00f07ae22d" />
